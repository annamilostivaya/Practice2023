...
{
    public class SingUpComand : CommandBase
    {
        ...
        public SingUpComand(RegistrationVM model, UserDbContext context,NavigationService<ItemsVM> ItemsVM, NavigationService<AdminView> AdminView)
        {
            Model = model;
            Context = context;
